<?php
    ...
    $url = "https://wwwlab.iit.his.se/bjuj/test/recieve.php?name=Johan&work=HIS&pet=Cat";

    $ch = curl_init();  //initializing the curl request
    curl_setopt($ch, CURLOPT_URL, $url); //set URL
    curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET"); // set the request type (GET, POST, PUT, DELETE... https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods )
